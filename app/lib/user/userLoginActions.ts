...
export async function createNewUserDocument({ userFirebase, userAnilist, openMenuFunctionHook }: CreateUserComponentTypes) {
    ...
    await setDoc(doc(collection(db, "users"), userId), userFirebase ?
        ...
        :
        {
            ...
            photoURL: userAnilist!.avatar?.large || userAnilist!.avatar?.medium || "https://i.pinimg.com/736x/fc/4e/f7/fc4ef7ec7265a1ebb69b4b8d23982d9d.jpg"
        }
    )
